...
require (
	github.com/decisiveai/watcher-collector/processors/datavolumeconnector v0.117.0
...
replace github.com/decisiveai/watcher-collector/processors/datavolumeconnector => ../../datavolumeconnector
