...
require (
	github.com/decisiveai/watcher-collector/connector/datavolumeconnector v0.117.0
...
replace github.com/decisiveai/watcher-collector/connector/datavolumeconnector => ../../datavolumeconnector
